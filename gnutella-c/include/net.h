...
NetError inet_subscribe_ping(struct INet, void (*consumer_fnc)());
NetError inet_subscribe_pong(struct INet, void (*consumer_fnc)(Peer peer));
NetError inet_subscribe_query(struct INet, void (*consumer_fnc)(struct string criteria));
NetError inet_subscribe_query_hit(struct INet, void (*consumer_fnc)(QueryHit hit_details));